...
class _ChecklistFormViewState extends State<ChecklistFormView> {
  ...
  Future _navigateToCreateForm(int currTemplate) async {
  ...
  void _insertDummyTemplate(Map<String, dynamic> templateData) async {
    try {
      // variable templateId akan menyimpan templateId dari dummy.
      int templateId = await DatabaseHelper.insertTemplate(templateData);
        ...
        children: [
          Positioned(
            ...
            child: FloatingActionButton(
              ...
              onPressed: () {
                //debug currtemp
                print('current template: $currTemplate');
                _navigateToCreateForm(currTemplate);
              },
